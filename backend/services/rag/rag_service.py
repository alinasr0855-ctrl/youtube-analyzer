...
class RAGService:
    ...
    def retrieve_context(self, question: str, session_meta: Dict, video_ids: Optional[List[str]] = None) -> Tuple[BuiltContext, List[RetrievalResult]]:
    ...
    def query(self, question: str, session_meta: Dict, chat_history: List[Dict], video_ids: Optional[List[str]] = None) -> Dict:
        t0 = time.time()
